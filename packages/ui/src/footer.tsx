    ...
    return (
        ...
        <footer className="flex flex-col lg:max-w-7xl mx-auto justify-center">
                ...
                <div className="text-[#5D5D5D] flex gap-14 pb-12 justify-center">
                    <Link href="/Blogs" className="hover:text-[#979797]">Blogs</Link>
                    <Link href="/create-account" className="hover:text-[#979797]">Get-started</Link>
                    <Link href="/Login" className="hover:text-[#979797]">login</Link>
                </div>
            </footer>
